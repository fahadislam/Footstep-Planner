...
FootstepPlanner::setPlanner()
{
  ...
  {
    ivPlannerPtr.reset(
        new ARAPlanner(ivPlannerEnvironmentPtr.get(),     //initialize planner fahad
...
//fahad
  if (force_new_plan        
      || ivPlannerType == "RSTARPlanner" || ivPlannerType == "ARAPlanner" || ivPlannerType == "MPlanner")
  {
    reset();
  }
